...
public interface AdaptorinterfacePackage extends EPackage {
     ...
     * @ordered
     */
    int SHACL_SHAPE__CLOSED = SHAPE_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int SHACL_SHAPE__SHACL_PROPERTIES = SHAPE_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int SHACL_SHAPE_FEATURE_COUNT = SHAPE_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    int SHACL_PROPERTY__MIN_COUNT = SHAPE_PROPERTY_FEATURE_COUNT + 1;
     ...
     * @ordered
     */
    int SHACL_PROPERTY__MAX_COUNT = SHAPE_PROPERTY_FEATURE_COUNT + 2;
     ...
     * @ordered
     */
    int SHACL_PROPERTY__DATA_TYPE = SHAPE_PROPERTY_FEATURE_COUNT + 3;
     ...
     * @ordered
     */
    int SHACL_PROPERTY__CLASS = SHAPE_PROPERTY_FEATURE_COUNT + 4;
     ...
     * @ordered
     */
    int SHACL_PROPERTY_FEATURE_COUNT = SHAPE_PROPERTY_FEATURE_COUNT + 5;
