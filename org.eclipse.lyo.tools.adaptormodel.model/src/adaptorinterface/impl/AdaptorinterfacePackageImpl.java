...
public class AdaptorinterfacePackageImpl extends EPackageImpl implements AdaptorinterfacePackage {
    ...
    public EAttribute getShaclShape_Closed() {
        return (EAttribute)shaclShapeEClass.getEStructuralFeatures().get(1);
    }
    ...
    public EReference getShaclShape_ShaclProperties() {
        return (EReference)shaclShapeEClass.getEStructuralFeatures().get(2);
    }
    ...
    public EAttribute getShaclProperty_MinCount() {
        return (EAttribute)shaclPropertyEClass.getEStructuralFeatures().get(1);
    }
    ...
    public EReference getShaclProperty_Class() {
        return (EReference)shaclPropertyEClass.getEStructuralFeatures().get(4);
    }
	...
	public void initializePackageContents() {
        ...
        initEAttribute(getShaclProperty_DataType(), this.getResourcePropertyValueType(), "dataType", null, 0, 1, ShaclProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
